...
public class SectorService : ISectorService
{
    ...
    // M�todo para obtener la cantidad de operaciones por empleado
    private async Task<int> ObtenerCantidadDeOperacionesPorEmpleado(Sectore sector)
    {
        // Obt�n todos los empleados relacionados con el sector desde el repositorio de empleados
        var empleados = await _unitOfWork.EmpleadoRepository.GetAll();

        // Filtra los empleados que pertenecen al sector espec�fico
